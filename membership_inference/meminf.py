...
def train_shadow_model(shadow_path, device, shadow_model, train_loader, test_loader,optimizer,criterion):
    model = shadow(train_loader, test_loader, shadow_model,optimizer,criterion, device)
    acc_train = 0
    acc_test = 0
...
# black shadow
def attack_mode0(TARGET_PATH, SHADOW_PATH, ATTACK_PATH, device, attack_trainloader, attack_testloader,
...
# white shadow
def attack_mode3(TARGET_PATH, SHADOW_PATH, ATTACK_PATH, device, attack_trainloader, attack_testloader,
                    target_model, shadow_model, attack_model, get_attack_set, num_classes):
